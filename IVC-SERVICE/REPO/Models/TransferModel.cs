...
namespace REPO.Models
{
    public partial class TransferModel
    {
        ...
        public string brtra_number { get; set; }
        public string job_id { get; set; }
        public string job_detail_id { get; set; }
        public string br_job_no { get; set; }
        ...
        public string bl_time_final { get; set; }
        public int diff_time_final { get; set; }
        ...
        public string bl_job_id { get; set; }
        public DateTime bl_job_date { get; set; }
        public string bl_job_no { get; set; }
        public string bl_invname { get; set; }
        public int bl_job_qty { get; set; }
        public int job_detail_subqty { get; set; }
        public int bl_job_detail_oldqty { get; set; }
        public int job_detail_oldqty { get; set; }
        public string bl_job_detail_qty { get; set; }
        public string bl_created_by { get; set; }
        public DateTime bl_created_date { get; set; }
        public string bl_updated_by { get; set; }
        public DateTime bl_updated_date { get; set; }
        public DateTime trndate_start { get; set; }
        public DateTime trndate_end { get; set; }
        public string bl_record_status { get; set; }
        public string bl_status_qty { get; set; }
        ...
        public DateTime vsm_job_date { get; set; }
        public string vsm_job_no { get; set; }
        public string klh_job_no { get; set; }
        public int status_chk_br { get; set; }
        public string brfile_number { get; set; }
        public DateTime brfile_invdate { get; set; }
    }
    ...
    public partial class TranferModel
    {
        // TR_Job //
        public string tranfer_number { get; set; }
        public string gbarcode { get; set; }
        public string tr_job_no { get; set; }
        public string pMessage { get; set; }
        ...
        public string tr_detail_trntype { get; set; }
        ...
        public int tr_detail_qty_old { get; set; }
        public int tr_detail_item { get; set; }
    }
    public partial class TranGetModel
    {
        // TR_Job //
        public string tranfer_number { get; set; }
        public string tr_job_no { get; set; }
        ...
        public string tr_no { get; set; }
        public int tr_qty { get; set; }
        public int tr_sum_qty { get; set; }
        public int tr_remark_qty { get; set; }
        public int qty { get; set; }
        public int diff_time_final { get; set; }
        public string tr_status_qty { get; set; }
        public string created_by { get; set; }
        public DateTime created_date { get; set; }
        public string updated_by { get; set; }
        public DateTime updated_date { get; set; }
        public DateTime tr_time_final { get; set; }
        public string record_status { get; set; }
        public DateTime time_final { get; set; }
        public string diff_time { get; set; }
        public string tr_count_suk { get; set; }

    }
    public partial class TranHistoryModel
    {
        // TR_Job //
        public string tr_job_no { get; set; }
        public string tr_detail_id { get; set; }
        ...
        public string tr_detail_location { get; set; }
        public int tr_detail_item { get; set; }
        public int tr_status_qty { get; set; }
        public int tr_remark_qty { get; set; }
        public int tr_qty_item { get; set; }
        public int qty_remark { get; set; }
        public int tr_detail_qty_old { get; set; }
    ...
    public partial class TranRemarkModel
    {
        // TR_Job //
        ...
        public int tr_remark_qty { get; set; }
        public string tr_remark_status { get; set; }
        public string tranfer_no { get; set; }
