...
namespace REPO.Controllers
{
    public class HrRepository
    {
        ...
        public SqlConnection VSK_HR;

        private void Connection()
        {

            VSK_HR = new SqlConnection(ConfigurationManager.ConnectionStrings["VSK_HR_187"].ToString());
        ...
        public List<DetailModel> Hr_Verify_Employee(DetailModel DetailModel)
        {
            try
            {
                ...
                Connection();
                VSK_HR.Open();
                List<DetailModel> HrList = SqlMapper.Query<DetailModel>(VSK_HR, "SP_Hr_Verify_Employee", objParam, commandTimeout: 210, commandType: CommandType.StoredProcedure).ToList();
        ...
        public List<DetailModel> Hr_Employee_Detail(DetailModel DetailModel)
        {
            try
            {
                ...
                Connection();
                VSK_HR.Open();
                List<DetailModel> HrList = SqlMapper.Query<DetailModel>(VSK_HR, "SP_Hr_employee_Detail", objParam, commandTimeout: 210, commandType: CommandType.StoredProcedure).ToList();
        ...
        public List<DetailModel> Hr_Employee_Time(DetailModel DetailModel)
        {
            try
            {
                ...
                Connection();
                VSK_HR.Open();
                List<DetailModel> HrList = SqlMapper.Query<DetailModel>(VSK_HR, "SP_Hr_Employee_Time", objParam, commandTimeout: 210, commandType: CommandType.StoredProcedure).ToList();
        ...
        public List<QuarterModel> Hr_Quarter_Get(QuarterModel QuarterModel)
        {
            try
            {
                ...
                Connection();
                VSK_HR.Open();
                List<QuarterModel> HrList = SqlMapper.Query<QuarterModel>(VSK_HR, "SP_Hr_Quarter_Get", objParam, commandTimeout: 210, commandType: CommandType.StoredProcedure).ToList();
        ...
        public List<QuarterModel> Hr_Quarter_Create(QuarterModel QuarterModel)
        {
            try
            {
                ...
                Connection();
                VSK_HR.Open();
                List<QuarterModel> HrList = SqlMapper.Query<QuarterModel>(VSK_HR, "SP_Hr_Quarter_Create", objParam, commandTimeout: 210, commandType: CommandType.StoredProcedure).ToList();
        ...
        public List<QuarterModel> Hr_Quarter_Update(QuarterModel QuarterModel)
        {
            try
            {
                ...
                Connection();
                VSK_HR.Open();
                List<QuarterModel> HrList = SqlMapper.Query<QuarterModel>(VSK_HR, "SP_Hr_Quarter_Update", objParam, commandTimeout: 210, commandType: CommandType.StoredProcedure).ToList();
        ...
        public List<CreateDATAModel> Hr_Create_Data(CreateDATAModel CreateDATAModel)
        {
            try
            {
                ...
                Connection();
                VSK_HR.Open();
                List<CreateDATAModel> HrList = SqlMapper.Query<CreateDATAModel>(VSK_HR, "SP_Hr_Create_Data", objParam, commandTimeout: 210, commandType: CommandType.StoredProcedure).ToList();
        ...
        public void Hr_Create_Score(List<ScoreCreateModel> ScoreCreateModel)
        {
            try
            {
                ...
                foreach (var HR_ScoreData in ScoreCreateModel)
                {
                    ...
                    Connection();
                    VSK_HR.Open();
                    VSK_HR.Execute("SP_Hr_Create_Score", objParam, commandType: CommandType.StoredProcedure, commandTimeout: 210);
                    VSK_HR.Close();
                }
        ...
        public List<CreateDATAModel> Hr_Update_Data(CreateDATAModel CreateDATAModel)
        {
            try
            {
                ...
                Connection();
                VSK_HR.Open();
                List<CreateDATAModel> HrList = SqlMapper.Query<CreateDATAModel>(VSK_HR, "SP_Hr_Status_Data", objParam, commandTimeout: 210, commandType: CommandType.StoredProcedure).ToList();
        ...
        public List<CreateDATAModel> Hr_Delete_Data(CreateDATAModel CreateDATAModel)
        {
            try
            {
                ...
                Connection();
                VSK_HR.Open();
                List<CreateDATAModel> HrList = SqlMapper.Query<CreateDATAModel>(VSK_HR, "SP_Hr_Delete_Data", objParam, commandTimeout: 210, commandType: CommandType.StoredProcedure).ToList();
        ...
        public void Hr_Employee_Import_Create(List<EmployeeModel> EmployeeModel)
        {
            try
            {
                ...
                foreach (var Employee_Data in EmployeeModel)
                {
                    ...
                    objParam.Add("@action_type", Employee_Data.action_type);
                    ...
                    objParam.Add("@employee_level", Employee_Data.employee_level);
                   

                    Connection();
                    VSK_HR.Open();
                    VSK_HR.Execute("SP_Hr_Employee_Temp_Create", objParam, commandType: CommandType.StoredProcedure, commandTimeout: 210);
                    VSK_HR.Close();
                }
        ...
        public List<EmployeeModel> Hr_Employee_Import_Verify(EmployeeModel EmployeeModel)
        {
            try
            {
                ...
                objParam.Add("@temp_id", EmployeeModel.temp_id);

                Connection();
                VSK_HR.Open();
                List<EmployeeModel> HrList = SqlMapper.Query<EmployeeModel>(VSK_HR, "SP_Hr_Employee_Temp_Verify", objParam, commandTimeout: 210, commandType: CommandType.StoredProcedure).ToList();
        ...
        public List<EmployeeModel> Hr_Employee_Import_Upload(EmployeeModel EmployeeModel)
        {
            try
            {
                ...
                Connection();
                VSK_HR.Open();
                List<EmployeeModel> HrList = SqlMapper.Query<EmployeeModel>(VSK_HR, "SP_Hr_Employee_Temp_Upload", objParam, commandTimeout: 210, commandType: CommandType.StoredProcedure).ToList();
        ...
        public List<EmployeeModel> Hr_Employee_Create(EmployeeModel EmployeeModel)
        {
            try
            {
                ...
                Connection();
                VSK_HR.Open();
                List<EmployeeModel> HrList = SqlMapper.Query<EmployeeModel>(VSK_HR, "SP_Hr_Employee_Create", objParam, commandTimeout: 210, commandType: CommandType.StoredProcedure).ToList();
        ...
        public List<EmployeeModel> Hr_Employee_Get(EmployeeModel EmployeeModel)
        {
            try
            {
                ...
                Connection();
                VSK_HR.Open();
                List<EmployeeModel> HrList = SqlMapper.Query<EmployeeModel>(VSK_HR, "SP_Hr_Employee_Get", objParam, commandTimeout: 210, commandType: CommandType.StoredProcedure).ToList();
        ...
        public List<EmployeeModel> Hr_Employee_Update(EmployeeModel EmployeeModel)
        {
            try
            {
                ...
                Connection();
                VSK_HR.Open();
                List<EmployeeModel> HrList = SqlMapper.Query<EmployeeModel>(VSK_HR, "SP_Hr_Employee_Update", objParam, commandTimeout: 210, commandType: CommandType.StoredProcedure).ToList();
        ...
        public List<EmployeeModel> Hr_Employee_Delete(EmployeeModel EmployeeModel)
        {
            try
            {
                ...
                Connection();
                VSK_HR.Open();
                List<EmployeeModel> HrList = SqlMapper.Query<EmployeeModel>(VSK_HR, "SP_Hr_Employee_Delete", objParam, commandTimeout: 210, commandType: CommandType.StoredProcedure).ToList();
        ...
        public List<JobModel> Hr_Job_Get(JobModel JobModel)
        {
            try
            {
                ...
                Connection();
                VSK_HR.Open();
                List<JobModel> HrList = SqlMapper.Query<JobModel>(VSK_HR, "SP_Hr_Job", objParam, commandTimeout: 210, commandType: CommandType.StoredProcedure).ToList();
        ...
        #region Hr_Job_List
        public List<JobModel> Hr_Job_List(JobModel JobModel)
        {
            try
            {
                ...
                objParam.Add("@job_type", JobModel.job_type);
                objParam.Add("@job_name", JobModel.job_name);

                Connection();
                VSK_HR.Open();
                List<JobModel> HrList = SqlMapper.Query<JobModel>(VSK_HR, "SP_Hr_Job_List", objParam, commandTimeout: 210, commandType: CommandType.StoredProcedure).ToList();
        ...
        public List<JobModel> Hr_Job_Create(JobModel JobModel)
        {
            try
            {
                ...
                objParam.Add("@created_by", JobModel.created_by);
                objParam.Add("@job_type", JobModel.job_type);
                objParam.Add("@job_name", JobModel.job_name);

                Connection();
                VSK_HR.Open();
                List<JobModel> HrList = SqlMapper.Query<JobModel>(VSK_HR, "SP_Hr_Job_Create", objParam, commandTimeout: 210, commandType: CommandType.StoredProcedure).ToList();
        ...
        public List<JobModel> Hr_Job_Update(JobModel JobModel)
        {
            try
            {
                ...
                objParam.Add("@updated_by", JobModel.created_by);
                objParam.Add("@job_type", JobModel.job_type);
                objParam.Add("@job_name", JobModel.job_name);
                objParam.Add("@job_id", JobModel.job_id);

                Connection();
                VSK_HR.Open();
                List<JobModel> HrList = SqlMapper.Query<JobModel>(VSK_HR, "SP_Hr_Job_Update", objParam, commandTimeout: 210, commandType: CommandType.StoredProcedure).ToList();
        ...
        #region Hr_Job_Update
        public List<JobModel> Hr_Job_Delete(JobModel JobModel)
        {
            try
            {
                ...
                objParam.Add("@updated_by", JobModel.updated_by);
                objParam.Add("@job_id", JobModel.job_id);

                Connection();
                VSK_HR.Open();
                List<JobModel> HrList = SqlMapper.Query<JobModel>(VSK_HR, "SP_Hr_Job_Delete", objParam, commandTimeout: 210, commandType: CommandType.StoredProcedure).ToList();
        ...
        public List<TimeModel> Hr_Time_Get(TimeModel TimeModel)
        {
            try
            {
                ...
                Connection();
                VSK_HR.Open();
                List<TimeModel> HrList = SqlMapper.Query<TimeModel>(VSK_HR, "SP_Hr_Time_Get", objParam, commandTimeout: 210, commandType: CommandType.StoredProcedure).ToList();
        ...
        public void Hr_Time_Create(List<TimeModel> TimeModel)
        {
            try
            {
                ...
                foreach (var TIME_JOBData in TimeModel)
                {
                    ...
                    Connection();
                    VSK_HR.Open();
                    VSK_HR.Execute("SP_Hr_Time_Create", objParam, commandType: CommandType.StoredProcedure, commandTimeout: 210);
                    VSK_HR.Close();
                }
        ...
        public List<ChackDataModel> Hr_Check_Data(ChackDataModel ChackDataModel)
        {
            try
            {
                ...
                Connection();
                VSK_HR.Open();
                List<ChackDataModel> HrList = SqlMapper.Query<ChackDataModel>(VSK_HR, "SP_Hr_Check_Data", objParam, commandTimeout: 210, commandType: CommandType.StoredProcedure).ToList();
        ...
        public List<ResultsModel> Hr_Results_Admin_Get(ResultsModel ResultsModel)
        {
            try
            {
                ...
                Connection();
                VSK_HR.Open();
                List<ResultsModel> HrList = SqlMapper.Query<ResultsModel>(VSK_HR, "SP_Hr_Assessment_Results_Admin", objParam, commandTimeout: 210, commandType: CommandType.StoredProcedure).ToList();
        ...
        public List<ResultsModel> Hr_Results_Manage_Get(ResultsModel ResultsModel)
        {
            try
            {
                ...
                Connection();
                VSK_HR.Open();
                List<ResultsModel> HrList = SqlMapper.Query<ResultsModel>(VSK_HR, "SP_Hr_Assessment_Results_Manage", objParam, commandTimeout: 210, commandType: CommandType.StoredProcedure).ToList();
        ...
        public List<ReportPmsModel> Hr_Report_Pms(ReportPmsModel ReportPmsModel)
        {
            try
            {
                ...
                Connection();
                VSK_HR.Open();
                List<ReportPmsModel> HrList = SqlMapper.Query<ReportPmsModel>(VSK_HR, "SP_Hr_Report_Pms", objParam, commandTimeout: 210, commandType: CommandType.StoredProcedure).ToList();
        ...
        public List<FormModel> Hr_Form_Get(FormModel FormModel)
        {
            try
            {
                ...
                Connection();
                VSK_HR.Open();
                List<FormModel> HrList = SqlMapper.Query<FormModel>(VSK_HR, "SP_Hr_Form_Get", objParam, commandTimeout: 210, commandType: CommandType.StoredProcedure).ToList();
        ...
        public List<FormModel> Hr_Form_More_Get(FormModel FormModel)
        {
            try
            {
                ...
                Connection();
                VSK_HR.Open();
                List<FormModel> HrList = SqlMapper.Query<FormModel>(VSK_HR, "SP_Hr_Form_More_Get", objParam, commandTimeout: 210, commandType: CommandType.StoredProcedure).ToList();
        ...
        public List<Result_Assess_Model> Hr_Result_Assess_Get(Result_Assess_Model Result_Assess_Model)
        {
            try
            {
                ...
                Connection();
                VSK_HR.Open();
                List<Result_Assess_Model> HrList = SqlMapper.Query<Result_Assess_Model>(VSK_HR, "SP_Hr_Result_Assess_Get", objParam, commandTimeout: 210, commandType: CommandType.StoredProcedure).ToList();
        ...
        public List<EmployeeModel> Hr_Verify_Assess_Get(EmployeeModel EmployeeModel)
        {
            try
            {
                ...
                Connection();
                VSK_HR.Open();
                List<EmployeeModel> HrList = SqlMapper.Query<EmployeeModel>(VSK_HR, "SP_Hr_Verify_Assess", objParam, commandTimeout: 210, commandType: CommandType.StoredProcedure).ToList();
        ...
        public List<Master_Model> Hr_Master_Get(Master_Model Master_Model)
        {
            try
            {
                ...
                Connection();
                VSK_HR.Open();
                List<Master_Model> HrList = SqlMapper.Query<Master_Model>(VSK_HR, "SP_Hr_Master_Get", objParam, commandTimeout: 210, commandType: CommandType.StoredProcedure).ToList();
        ...
        public List<Confirm_Model> Hr_Assess_Confirm(Confirm_Model Confirm_Model)
        {
            try
            {
                ...
                Connection();
                VSK_HR.Open();
                List<Confirm_Model> HrList = SqlMapper.Query<Confirm_Model>(VSK_HR, "SP_Hr_Assess_Confirm", objParam, commandTimeout: 210, commandType: CommandType.StoredProcedure).ToList();
