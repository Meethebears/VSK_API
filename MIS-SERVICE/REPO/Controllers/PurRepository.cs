...
namespace REPO.Controllers
{
    public class PurRepository
    {
        ...
        #region PR_POE_IV_GR_bySale 
        public List<PkPoIVModel> PR_POE_IV_GR_bySale(PkPoIVModel PkPoIVModel)
        {
            try
            {
                ...
                Connection();
                mscon.Open();
                List<PkPoIVModel> PkPoIVList = SqlMapper.Query<PkPoIVModel>(mscon, "SP_PR_POE_IV_GR_bySale_v2", objParam, commandTimeout: 210, commandType: CommandType.StoredProcedure).ToList();
        ...
        #region PR_POE_IV_GR_bySale_Update
        ...
        #region Custome_PR_Get 
        public List<CustomePRModel> Custome_PR_Get(string pono_e,  string stkcod)
        {
            ...
            try
            {
                ...
                objParam.Add("@stkcod", stkcod);

                Connection();
                mscon.Open();
                List<CustomePRModel> RequestModelList = SqlMapper.Query<CustomePRModel>(mscon, "SP_Custome_PR_Get", objParam, commandType: CommandType.StoredProcedure).ToList();
                mscon.Close();
        ...
        #region PR_POE_IV_GR_bySale_Close 
        public List<PkPoIVModel> PR_POE_IV_GR_bySale_Close(PkPoIVModel PkPoIVModel)
        {
            try
            {
                ...
                Connection();
                mscon.Open();
                List<PkPoIVModel> PkPoIVList = SqlMapper.Query<PkPoIVModel>(mscon, "SP_PR_POE_IV_GR_bySale_Close_v2", objParam, commandTimeout: 210, commandType: CommandType.StoredProcedure).ToList();
