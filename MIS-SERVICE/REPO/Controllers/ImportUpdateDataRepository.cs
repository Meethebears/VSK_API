    ...
    public class ImportUpdateDataRepository
    {
        ...
        public void ImportUpdateData_Tran_Create(List<ImportUpdateDataTranModel> ImportUpdateDataTranModel)
        {
            try
            {
                foreach (var ImportUpdateDataArrayData in ImportUpdateDataTranModel)
                {
                    ...
                    //VSK_Data.Execute("SP_ItemMaster_ImportUpdateData_Tran_Create_20210830_new", objParam, commandTimeout: 600, commandType: CommandType.StoredProcedure);
                    VSK_Data.Close();
                }
            }
            catch (Exception ex)
        ...
        public List<ImportUpdateDataTranModel> ItemMaster_ImportUpdateData_TemplateGet(string temp_id, string created_by, string created_by2)
        {
            try
            {
                ...
                //List<ImportUpdateDataTranModel> RequestModelList = SqlMapper.Query<ImportUpdateDataTranModel>(VSK_Data, "SP_ItemMaster_ImportUpdateData_Template_Get_20211007_new", objParam, commandTimeout: 600, commandType: CommandType.StoredProcedure).ToList();
                VSK_Data.Close();
                return RequestModelList.ToList();
            }
            catch (Exception ex)
