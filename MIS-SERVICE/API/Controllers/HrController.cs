...
namespace API.Controllers
{
    public class HrController : ApiController
    {
        ...
        [Route("api/Hr_Employee_Import")]
        [HttpPost]
        public ResponseModel Hr_Employee_Import(List<EmployeeModel> EmployeeModel)
        {
            try
            {
                HrRepository HrRepository = new HrRepository();
                ...
                foreach (var Employee_Data in EmployeeModel)
                {
                    ...
                    TIME_JOBModel_data.user_id = Employee_Data.user_id;
                   ...
                   // TIME_JOBModel_data.employee_full_name_th = Employee_Data.employee_full_name_th;
                    ...
                    //TIME_JOBModel_data.employee_full_name_en = Employee_Data.employee_full_name_en;
                    TIME_JOBModel_data.employee_nickname_en = Employee_Data.employee_nickname_en;
                    TIME_JOBModel_data.employee_photo = Employee_Data.employee_photo;
                ...
                HrRepository.Hr_Employee_Import(Employee_List);
